...
const config = {
	...
	color: "#1c1fc9", // TODO: Choose color
	head: "silly", // TODO: Choose head, see https://play.battlesnake.com/customizations/ for options unlocked in your account
...
app.post("/move", (req,res) =>{
	res.status(200).json(move(req.body));
})
